...
All puzzles run. My next task will be to test for correctness again (they all passed at the time I wrote them, but sometimes solutions can fail with different inputs). Lastly will be attempting to get all runtimes under 30 seconds (currently about 20 take too long).
