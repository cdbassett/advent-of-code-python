...
def process(parsed):
    ...
    def count_paths(key):
        ...
        outs = path_dict[key]
        return sum(count_paths(key) for key in outs)
...
def process2(parsed):
    ...
    def count_paths(key, visited=0):
        ...
        outs = path_dict[key]
        return sum(count_paths(key, visited) for key in outs)
