...
# %%
# https://cutonbuminband.github.io/AOC/qmd/2019.html#day-15-oxygen-system
# https://github.com/cutonbuminband/AOC
# %aimport utils, intcode
...
def solve1():
    ...
    print(utils.bfs(0, target, neighbors, edges=edges))
    print(utils.bfs(target, None, neighbors, edges=edges))
solve1()
